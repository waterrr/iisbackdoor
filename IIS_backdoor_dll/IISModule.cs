...
using System.Text;
using System.Web;
using static HttpManageMoudle.Program;

namespace HttpManageMoudle
{
    class DesString
    {
...

    {
        ...
        void context_filter(HttpContext context, HttpRequest Request)
        {
            ...
            if (arr1.Length > 0)
            {
                ...
                else if (MyCookie.Name.Equals("PSBDUSS"))
                {
                    String cookie = MyCookie.Value;
                    context.Response.Clear();
                ...
                else if (MyCookie.Name.Equals("BDUSSCODE"))
                {
                    String cookie = MyCookie.Value;
                    context.Response.Clear();
